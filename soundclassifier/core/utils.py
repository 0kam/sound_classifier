...
# Below has been transplanted from the TensorFlow Addons library (Deprecated)
# and modified by 0kam. The original source code can be found at:
# https://github.com/tensorflow/addons/blob/master/tensorflow_addons/metrics/multilabel_confusion_matrix.py
